...
export const PostFullContent = styled.section`
  ...
  padding: 0 170px 6vw;
  min-height: 230px;
  font-family: 'Nanum Gothic',system-ui,Georgia, serif;
  font-size: 2rem;
  line-height: 1.6em;
  background: #fff;
  ...
  h6 {
    /* color: color(var(--darkgrey) l(-5%)); */
    color: ${lighten('-0.05', colors.darkgrey)};
    font-family: 'Nanum Gothic',system-ui,-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell,
